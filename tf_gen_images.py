...
def gen_images(image_dir,calib_list,max_images,dataset):
    ...
    (x_train,y_train), (x_test,y_test) = data_preprocess(normalize=0)
	
    classes = ['COVID-19','NORMAL','Viral Pneumonia']	 #our classes
    ...
    with tf.compat.v1.Session() as sess:
        ...
        for i in range(len(x_test[:max_images])):
            ...
            img_file=os.path.join(image_dir, classes[numpy.argmax(y_feed[i])]+'_'+str(i)+'.jpg')
